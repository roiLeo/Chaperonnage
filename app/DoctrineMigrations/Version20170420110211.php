 ...
 */
class Version20170420110211 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE fos_user ADD total_facebook_friends VARCHAR(255) DEFAULT NULL, CHANGE phone phone VARCHAR(10) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE fos_user DROP total_facebook_friends, CHANGE phone phone VARCHAR(10) NOT NULL COLLATE utf8_unicode_ci');
    }
}
